...
import com.practice.domain.user.SocialType;
import com.practice.domain.user.User;
import com.practice.domain.user.repository.UserRepository;
import com.practice.oauth.CustomOAuth2User;
import com.practice.oauth.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        String userNameAttributeName = userRequest.getClientRegistration()
            ...
            .getUserNameAttributeName(); // OAuth2 로그인 시 키(PK)가 되는 값, userRequest에서 가져옴.
        String userName = oAuth2User.getAttribute(userNameAttributeName); // OAuth2 로그인 시 키(PK)가 되는 값, DefaultOAuth2User 객체에도 존재함.
        //TODO
        // userNameAttributeName과 userName 같은지 확인해보기.
